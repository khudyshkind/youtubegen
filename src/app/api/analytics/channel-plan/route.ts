...
КРИТИЧНО: внутри строковых значений JSON НЕ используй символ двойной кавычки (") — вместо этого используй апостроф (') или перефразируй. Не допускай переносов строк внутри значений.
