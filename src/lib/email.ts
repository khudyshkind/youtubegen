...
const APP  = () => env('NEXT_PUBLIC_APP_URL') || 'https://youtubegen.vercel.app'
...
export async function sendWelcomeEmail(user: { email: string; name?: string | null }) {
  ...
  const html = layout(`
    ...
    <div style="background:#fef2f2;border:1px solid #fecaca;border-radius:12px;padding:20px;margin-bottom:24px">
      <p style="margin:0;font-size:15px;color:#991b1b;font-weight:700">🎁 Вам начислено 20 бесплатных кредитов!</p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      ${[
        ...
        ['🎙️', 'Озвучка', 'ElevenLabs озвучивает профессиональным голосом'],
        ['💬', 'Субтитры', 'Whisper AI добавляет точные субтитры'],
        ['🖼️', 'Иллюстрации', 'Flux AI генерирует уникальные картинки'],
