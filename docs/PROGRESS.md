> ⚠️ ЗАМОРОЖЕН 22.07.2026. Это исторический журнал сборки фаз 1-13,
> а не источник правды. Δ1-Δ12 в нём не отражены.
> Как карта кода ненадёжен: часть путей устарела — в частности озвучка
> уехала с ElevenLabs на APIHOST/SecretVoicer, платежи с Paddle на ЮKassa.
> Актуальные задачи: docs/TASKS.md. Устройство системы: docs/CONTEXT.md.
