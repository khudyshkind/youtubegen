...
### [2026-08-09] Chunked-сценарий теряет сквозные факты между секциями — ⏳ РЕШЕНИЕ СОГЛАСОВЫВАЕТСЯ
...
**Решение:** ⏳ Ожидает согласования варианта с владельцем. После согласования — один Haiku-вызов перед `generateChunkedScript`, результат в system-промпт каждой секции.
